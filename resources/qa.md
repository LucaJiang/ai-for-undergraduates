...
`python scripts/check_sources.py` checks 54 slide anchors, one notes block per slide, no nested slide sections or duplicated clipboard content, selected reader-facing regressions, and local links.
...
- 54 slides at 1280×720 and 1440×900, notes, selected text contrast and vertical slide bounds; saves screenshots for visual review.
