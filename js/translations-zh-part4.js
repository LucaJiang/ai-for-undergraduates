/* Additional reviewed Simplified Chinese copy for Part 4 slides. */
window.WorkshopChinese = Object.freeze(Object.assign({}, window.WorkshopChinese, {
  "If there is no slider, use a conversation loop.": "没有滑块时，就用对话循环。",
  "Template first": "先给模板",
  "Gemini asks for parameters.": "让 Gemini 先列出要填的参数。",
