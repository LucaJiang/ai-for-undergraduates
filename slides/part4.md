...
操作：使用彩排时可用的模式，有 Pro 可以先选它。若没有生成可操作的内容，用下一页之后的本站 PPV 工具继续；具体操作参考 interactive-guide。
...
若只返回文字，可以追问一次：“Please show the interactive visualization directly in this conversation.” 仍没出现就用我们准备好的网页。
